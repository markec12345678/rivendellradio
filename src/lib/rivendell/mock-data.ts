...
// Fixed timestamp to prevent hydration mismatches (server vs client)
const NOW = 1752100000000 // Fixed epoch ms — July 2026
...
export const rockTracks: Track[] = [
  // Classic Rock
  { id: 't001', title: 'Back in Black', artist: 'AC/DC', album: 'Back in Black', genre: 'Hard Rock', length: 253000, type: 'music', bpm: 127, year: 1980, isrc: 'AUAP08000012', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1247, lastPlayed: new Date(NOW - 3600000).toISOString(), albumArt: albumArtFor('Hard Rock', 'music') },
  { id: 't002', title: 'Highway to Hell', artist: 'AC/DC', album: 'Highway to Hell', genre: 'Hard Rock', length: 208000, type: 'music', bpm: 116, year: 1979, isrc: 'AUAP79000011', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 983, lastPlayed: new Date(NOW - 7200000).toISOString(), albumArt: albumArtFor('Hard Rock', 'music') },
  { id: 't003', title: 'Thunderstruck', artist: 'AC/DC', album: 'The Razors Edge', genre: 'Hard Rock', length: 292000, type: 'music', bpm: 133, year: 1990, isrc: 'AUAP90000009', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1567, lastPlayed: new Date(NOW - 1800000).toISOString(), albumArt: albumArtFor('Hard Rock', 'music') },
  { id: 't004', title: 'Bohemian Rhapsody', artist: 'Queen', album: 'A Night at the Opera', genre: 'Classic Rock', length: 354000, type: 'music', bpm: 72, year: 1975, isrc: 'GBUM75000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 2104, lastPlayed: new Date(NOW - 900000).toISOString(), albumArt: albumArtFor('Classic Rock', 'music') },
  { id: 't005', title: 'We Will Rock You', artist: 'Queen', album: 'News of the World', genre: 'Classic Rock', length: 122000, type: 'music', bpm: 81, year: 1977, isrc: 'GBUM77000002', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1893, lastPlayed: new Date(NOW - 5400000).toISOString(), albumArt: albumArtFor('Classic Rock', 'music') },
  { id: 't006', title: 'Don\'t Stop Believin\'', artist: 'Journey', album: 'Escape', genre: 'Classic Rock', length: 251000, type: 'music', bpm: 119, year: 1981, isrc: 'USSM18100012', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 2456, lastPlayed: new Date(NOW - 2700000).toISOString(), albumArt: albumArtFor('Classic Rock', 'music') },
  { id: 't007', title: 'Sweet Child O\' Mine', artist: 'Guns N\' Roses', album: 'Appetite for Destruction', genre: 'Hard Rock', length: 356000, type: 'music', bpm: 126, year: 1987, isrc: 'USGF87000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1789, lastPlayed: new Date(NOW - 14400000).toISOString(), albumArt: albumArtFor('Hard Rock', 'music') },
  { id: 't008', title: 'Welcome to the Jungle', artist: 'Guns N\' Roses', album: 'Appetite for Destruction', genre: 'Hard Rock', length: 273000, type: 'music', bpm: 118, year: 1987, isrc: 'USGF87000002', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1342, lastPlayed: new Date(NOW - 10800000).toISOString(), albumArt: albumArtFor('Hard Rock', 'music') },
  { id: 't009', title: 'Stairway to Heaven', artist: 'Led Zeppelin', album: 'Led Zeppelin IV', genre: 'Classic Rock', length: 482000, type: 'music', bpm: 82, year: 1971, isrc: 'GBUM71000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1934, lastPlayed: new Date(NOW - 21600000).toISOString(), albumArt: albumArtFor('Classic Rock', 'music') },
  { id: 't010', title: 'Whole Lotta Love', artist: 'Led Zeppelin', album: 'Led Zeppelin II', genre: 'Classic Rock', length: 334000, type: 'music', bpm: 90, year: 1969, isrc: 'GBUM69000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1123, lastPlayed: new Date(NOW - 28800000).toISOString(), albumArt: albumArtFor('Classic Rock', 'music') },
  { id: 't011', title: 'Smoke on the Water', artist: 'Deep Purple', album: 'Machine Head', genre: 'Hard Rock', length: 370000, type: 'music', bpm: 112, year: 1972, isrc: 'GBUM72000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 892, lastPlayed: new Date(NOW - 36000000).toISOString(), albumArt: albumArtFor('Hard Rock', 'music') },
  { id: 't012', title: 'Paranoid', artist: 'Black Sabbath', album: 'Paranoid', genre: 'Heavy Metal', length: 171000, type: 'music', bpm: 154, year: 1970, isrc: 'GBUM70000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1045, lastPlayed: new Date(NOW - 43200000).toISOString(), albumArt: albumArtFor('Heavy Metal', 'music') },

  // Alternative / Grunge
  { id: 't013', title: 'Smells Like Teen Spirit', artist: 'Nirvana', album: 'Nevermind', genre: 'Grunge', length: 301000, type: 'music', bpm: 116, year: 1991, isrc: 'USGF91000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 2678, lastPlayed: new Date(NOW - 1200000).toISOString(), albumArt: albumArtFor('Grunge', 'music') },
  { id: 't014', title: 'Come as You Are', artist: 'Nirvana', album: 'Nevermind', genre: 'Grunge', length: 219000, type: 'music', bpm: 120, year: 1991, isrc: 'USGF91000002', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1543, lastPlayed: new Date(NOW - 6800000).toISOString(), albumArt: albumArtFor('Grunge', 'music') },
  { id: 't015', title: 'Black Hole Sun', artist: 'Soundgarden', album: 'Superunknown', genre: 'Grunge', length: 320000, type: 'music', bpm: 134, year: 1994, isrc: 'USAM94000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1234, lastPlayed: new Date(NOW - 8200000).toISOString(), albumArt: albumArtFor('Grunge', 'music') },
  { id: 't016', title: 'Even Flow', artist: 'Pearl Jam', album: 'Ten', genre: 'Grunge', length: 293000, type: 'music', bpm: 126, year: 1991, isrc: 'USEP91000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1456, lastPlayed: new Date(NOW - 9600000).toISOString(), albumArt: albumArtFor('Grunge', 'music') },
  { id: 't017', title: 'Creep', artist: 'Radiohead', album: 'Pablo Honey', genre: 'Alternative Rock', length: 238000, type: 'music', bpm: 92, year: 1993, isrc: 'GBAP93000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1876, lastPlayed: new Date(NOW - 5200000).toISOString(), albumArt: albumArtFor('Alternative Rock', 'music') },

  // Modern Rock / Indie
  { id: 't018', title: 'Seven Nation Army', artist: 'The White Stripes', album: 'Elephant', genre: 'Alternative Rock', length: 232000, type: 'music', bpm: 124, year: 2003, isrc: 'USXL03000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 2014, lastPlayed: new Date(NOW - 3400000).toISOString(), albumArt: albumArtFor('Alternative Rock', 'music') },
  { id: 't019', title: 'Use Somebody', artist: 'Kings of Leon', album: 'Only by the Night', genre: 'Alternative Rock', length: 207000, type: 'music', bpm: 104, year: 2008, isrc: 'USRN08000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1342, lastPlayed: new Date(NOW - 15600000).toISOString(), albumArt: albumArtFor('Alternative Rock', 'music') },
  { id: 't020', title: 'The Pretender', artist: 'Foo Fighters', album: 'Echoes, Silence, Patience & Grace', genre: 'Alternative Rock', length: 269000, type: 'music', bpm: 168, year: 2007, isrc: 'USRN07000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1678, lastPlayed: new Date(NOW - 11200000).toISOString(), albumArt: albumArtFor('Alternative Rock', 'music') },
  { id: 't021', title: 'Everlong', artist: 'Foo Fighters', album: 'The Colour and the Shape', genre: 'Alternative Rock', length: 250000, type: 'music', bpm: 158, year: 1997, isrc: 'USCA97000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1923, lastPlayed: new Date(NOW - 4600000).toISOString(), albumArt: albumArtFor('Alternative Rock', 'music') },
  { id: 't022', title: 'Hysteria', artist: 'Muse', album: 'Absolution', genre: 'Alternative Rock', length: 227000, type: 'music', bpm: 94, year: 2003, isrc: 'GBAAR03000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1089, lastPlayed: new Date(NOW - 19800000).toISOString(), albumArt: albumArtFor('Alternative Rock', 'music') },
  { id: 't023', title: 'Knights of Cydonia', artist: 'Muse', album: 'Black Holes and Revelations', genre: 'Alternative Rock', length: 366000, type: 'music', bpm: 138, year: 2006, isrc: 'GBAAR06000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1267, lastPlayed: new Date(NOW - 22400000).toISOString(), albumArt: albumArtFor('Alternative Rock', 'music') },
  { id: 't024', title: 'In the End', artist: 'Linkin Park', album: 'Hybrid Theory', genre: 'Nu Metal', length: 216000, type: 'music', bpm: 105, year: 2001, isrc: 'USWB00000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 2345, lastPlayed: new Date(NOW - 6200000).toISOString(), albumArt: albumArtFor('Nu Metal', 'music') },
  { id: 't025', title: 'Numb', artist: 'Linkin Park', album: 'Meteora', genre: 'Nu Metal', length: 187000, type: 'music', bpm: 110, year: 2003, isrc: 'USWB02000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 2156, lastPlayed: new Date(NOW - 13800000).toISOString(), albumArt: albumArtFor('Nu Metal', 'music') },

  // Punk / Pop Punk
  { id: 't026', title: 'Blitzkrieg Bop', artist: 'Ramones', album: 'Ramones', genre: 'Punk Rock', length: 142000, type: 'music', bpm: 173, year: 1976, isrc: 'USSM76000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 678, lastPlayed: new Date(NOW - 31200000).toISOString(), albumArt: albumArtFor('Punk Rock', 'music') },
  { id: 't027', title: 'American Idiot', artist: 'Green Day', album: 'American Idiot', genre: 'Punk Rock', length: 177000, type: 'music', bpm: 98, year: 2004, isrc: 'USWR04000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1432, lastPlayed: new Date(NOW - 17400000).toISOString(), albumArt: albumArtFor('Punk Rock', 'music') },
  { id: 't028', title: 'Boulevard of Broken Dreams', artist: 'Green Day', album: 'American Idiot', genre: 'Punk Rock', length: 262000, type: 'music', bpm: 104, year: 2004, isrc: 'USWR04000002', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1789, lastPlayed: new Date(NOW - 20200000).toISOString(), albumArt: albumArtFor('Punk Rock', 'music') },

  // Stadium Rock
  { id: 't029', title: 'Livin\' on a Prayer', artist: 'Bon Jovi', album: 'Slippery When Wet', genre: 'Classic Rock', length: 250000, type: 'music', bpm: 123, year: 1986, isrc: 'USPR86000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 2045, lastPlayed: new Date(NOW - 4400000).toISOString(), albumArt: albumArtFor('Classic Rock', 'music') },
  { id: 't030', title: 'It\'s My Life', artist: 'Bon Jovi', album: 'Crush', genre: 'Classic Rock', length: 224000, type: 'music', bpm: 120, year: 2000, isrc: 'USPR00000001', group: 'MUSIC', origin: 'cd', schedCodes: ['M', 'R'], playCount: 1234, lastPlayed: new Date(NOW - 16600000).toISOString(), albumArt: albumArtFor('Classic Rock', 'music') },
